...
public final class Log
{
    public static Log l =new Log();
     String propsFile="SmsPusherScheduler.properties",GATEWAYURL,INFO_LOG_FILE, ERROR_LOG_FILE,FATAL_LOG_FILE, MAX_LOGFILE_SIZE = "100MB",INFO_LOG_LEVEL, ERROR_LOG_LEVEL,FATAL_LOG_LEVEL,
    ...
    public  int MAX_NUM_LOGFILES,NO_OF_THREAD,BUCKET_SIZE,PENDING_STATUS,PICKED_STATUS,FAILED_STATUS,FAILED_STATUS2,SUCCESS_STATUS,SLEEP_TIME;
   ...
   public void loadProperties() {
		try {
			...
			/* Extract the values for the values in the configuration file */
                        GATEWAYURL=props.getProperty("GATEWAYURL");
			...
			ERROR_LOG_LEVEL = props.getProperty("ERROR_LOG_LEVEL");
                ...
                {
                    l.errorLog.fatal("caught IOException attempting to loadProperties "+ ioe);
                        l.errorLog.fatal("Application will exit now");
                        System.exit(0);
		}
	}
    ...
    public void initializeLoggers() {
        ...
        try
        {
            ...
            fatalLog.addAppender(rfaFATAL_LOG);
             ...
             l.errorLog.fatal("initiliazeLog --- EXCEPTION THROWN WHILE CREATING A RollingFileAppender"+ e);
        }
